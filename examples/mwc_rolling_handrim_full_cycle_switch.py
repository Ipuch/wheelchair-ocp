...
def prepare_ocp(
    ...
    holonomic_constraints.add(
        ...
        rotation_joint_index=1,
        radius=0.35,
    )  # add 1 cas pour le calcul explicite si 1/2 contraintes sont activées !!
    ...
    variable_bimapping_recovery.add(
        "q", to_second=[None, 0, 1, 2], to_first=[1, 2, 3]
    )  # piloté en x pour la recovery ?
